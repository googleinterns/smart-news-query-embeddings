...
Original file is located at
        https://colab.research.google.com/drive/16GXJW2pDSUQa_rjRqdRK1e7fKIoxiYl-
"""
...
class BERTTrainer():
    ...
    def _train_and_test_features_from_df(self):
        ...
        self.train_features = bert.run_classifier.convert_examples_to_features(train_InputExamples, self.label_list, self.max_seq_length, tokenizer)
        self.test_features = bert.run_classifier.convert_examples_to_features(test_InputExamples, self.label_list, self.max_seq_length, tokenizer)
