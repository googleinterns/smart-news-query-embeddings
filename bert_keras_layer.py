...
if __name__ == '__main__':
    ...
    df = get_filtered_nyt_data('nyt_data_from_2015.pkl').sample(5000, random_state=42)
    ...
    test_ids, test_labels = tokenize_data(test_df['abstract'], test_df['category_labels'], tokenizer)
    ...
    model.fit(train_ids, train_labels, validation_data=(test_ids, test_labels), epochs=1)

    model.save('bert_keras')
